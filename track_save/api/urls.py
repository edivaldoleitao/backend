...
urlpatterns = [
    ...
    path(
        "subscriptions/update/<int:subscription_id>/",
        subscription_views.update_subscription,
        name="update_subscription",
    ),
    path(
        "subscriptions/delete/<int:subscription_id>/",
        subscription_views.delete_subscription,
        name="delete_subscription",
    ),
    path(
        "subscriptions/user/delete/<int:subscription_id>/",
